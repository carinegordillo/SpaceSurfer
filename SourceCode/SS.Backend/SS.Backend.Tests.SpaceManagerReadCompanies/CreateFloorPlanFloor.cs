...
public class CreateFloorPlansFloor
{
    ...
    public async Task InsertFloorPlan1_Success()
    {
        ...
        string ImagePath = @"/Users/sarah/Documents/GitHub/SpaceSurfer/SourceCode/SS.Backend/FloorPlanImages/FloorPlan1.png";
    ...
    public async Task InsertFloorPlan2_Success()
    {
        ...
        int CompanyID = 9;
        string FloorPlanName = "Floor Plan 2";
        string ImagePath = @"/Users/sarah/Documents/GitHub/SpaceSurfer/SourceCode/SS.Backend/FloorPlanImages/FloorPlan2.png";
    ...
    //     string ImagePath = @"/Users/sarah/Documents/GitHub/SpaceSurfer/SourceCode/SS.Backend/FloorPlanImages/FloorPlan3.png";
    ...
    public async Task InsertFloorPlan3_Success()
    {
        ...
        int CompanyID = 10;
        string FloorPlanName = "Floor Plan 3";
        string ImagePath = @"/Users/sarah/Documents/GitHub/SpaceSurfer/SourceCode/SS.Backend/FloorPlanImages/FloorPlan3.png";
    ...
    //     int CompanyID = 1030;
    //     string FloorPlanName = "Floor Plan Test 3";
