...
namespace SS.Backend.Tests.Logging
{
   ...
   public class LoggingUnitTest
   {
    ...
    // [TestMethod]
    //    public async Task Please_Log()
    //    {
    //        // Arrange
    //        var log = new LogEntry
    //        {
    //            level = "Debug",
    //            username = "carine@email",
    //            category = "View",
    ...
    //    }
       ...
       public void Cleanup()
       {
           ...
           _command.CommandText = "DELETE FROM dbo.Logs WHERE [Username] = 'test@email'";
           dao.SqlRowsAffected(_command);
