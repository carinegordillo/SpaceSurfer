...
//// Function to update the UI with user reservations
...
//        reservationItem.textContent = `${reservation.date} - Place: ${reservation.place}, Time: ${reservation.time}`;
...
//    try {
//        // Fetch user reservations and wait for the response
//        reservations = await fetchUserReservations(fromDateInput, toDateInput);
...
//// Event listener for user confirmation
//document.getElementById('confirm-button').addEventListener('click', confirmSelection);
...
////        // If we've reached the end of the month, exit the loop
////        if (dayCounter > lastDay) {
////            break;
////        }
////    }
